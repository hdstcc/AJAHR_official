...
class PoseReConsLoss(nn.Module):
    def __init__(self, loss_params, nb_joints, rot_type, smpl_type):
        ...
        self.mask_loss = self.get_loss('BCE', 'mask')
    ...
    def forward_mask(self, gt_mask, output):
        ...
        print(pred_mask_classes, gt_mask)
        return self.mask_loss(pred_mask, gt_mask), accuracy