...
body_model = eval(f'{smpl_type.upper()}Layer')(body_model_path, num_betas=10, ext='pkl')    # /opt/conda/lib/python3.10/site-packages/smplx/body_models.py 
body_model = body_model.cuda() if torch.cuda.is_available() else body_model # smpl을 body_model로 인스턴스 선언
